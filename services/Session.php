...
class Session 
{
    ...
    public static function init(int $id, string $firstname, string $lastname, string $mail, string $phone, string $address, string $city, int $zipcode, int $isAdmin): void {
        $_SESSION['auth'] = [
            'id' => intval($id),
            'firstname' => $firstname,
            'lastname' => $lastname,
    ...
    public static function getLogged() {
        ...
        //Pour utiliser des props ou méthode static au sein de la classe elle même
